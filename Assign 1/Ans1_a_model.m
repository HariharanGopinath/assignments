clear all;
clc;
syms x y z l q p1 p2 g t1 t2 v1 v2 m1 m2 dx dy dz dq p1dot p2dot theta phi theta_dot phi_dot ux uy uz;
...
p2=[x+ l*cos(theta)*sin(phi); y+ l*sin(phi)*sin(theta); z-l*cos(phi)];
